...
export  const searchActiveIndex = onChangeImageByKey(galleryItems);
export  const galleryMarkup = createCardsGalleryMarkup(galleryItems);
...
export function createCardsGalleryMarkup(gallery) {
